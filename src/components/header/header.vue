    ...
    <div class="header">
        <div class="content-wrapper">
            ...
            <div class="content">
                ...
                <!-- v-if="seller.supports"确保不报错等到 有seller.supports再取seller.supports[0].description-->
            ...
            <div v-if="seller.supports" @click="showDetail" class="support-count">
                ...
                <span class="h-keyboard_arrow_right"></span>
            </div>
        </div>
        <div class="bulletin-wrapper" @click="showDetail">
            <span class="bulletin-title"></span>
            <span class="bulletin-text" v-text="seller.bulletin"></span>
            <i class="h-keyboard_arrow_right"></i>
        </div>
        ...
        <transition enter-active-class="animated fadeInDown" leave-active-class="animated fadeOutDown">
          <div class="detail" v-show="detailShow">
            <div class="detail-warpper clearfix">
              <div class="detail-main">
                ...
                <ul v-if="seller.supports" class="supports">
                  <li class="supports-item" v-for="(val,key) in seller.supports">
                    <span class="icon" :class="classMap[seller.supports[key].type]"></span>
                    <span class="text" v-text="seller.supports[key].description"></span>
                  </li>
                </ul>
                <div class="title">
                  <div class="line"></div>
            ...
            <div class="detail-close">
              <i class="h-close"  @click="hideDetail"></i>
            </div>
          </div>
        </transition>
    </div>
